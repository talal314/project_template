...
echo "3. Transformamos el UniProt ID de las proteínas a Chembl ID, buscándolos en Chembl DB"
Rscript code/convertirChembl.py results/human_proteins_uniprot.txt results/human_proteins_chembl.txt
echo "Archivo results/human_proteins_chembl.txt creado"

echo "4. Buscamos en Chembl los fármacos asociados a estas proteínas"
python3 code/consultarChembl.py results/human_proteins_chembl.txt 4 results/farmacos_aprobados.csv
python3 code/consultarChembl.py results/human_proteins_chembl.txt 3 results/farmacos_experimentales.csv
echo "Archivos results/farmacos_aprobados.csv y results/farmacos_experimentales.csv creados"

echo "5. Análisis de los resultados"
